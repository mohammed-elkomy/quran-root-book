...
HEADER_NAMES_AR = ["رقمها", "السورة", "رقمها", "الآية", "", ] # Globalisation
HEADER_NAMES_EN = ["Sura No", "Sura", "Aya No", "Verse", "", ] # Globalisation
...
GENERAL_TABLE_RATIOS_SINGLE = [.75, 1.5, .75, 8, 4, .5, ]  # 6 columns design
